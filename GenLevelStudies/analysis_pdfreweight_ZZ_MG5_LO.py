...
for member_name in tree["NNPDF31LO_Members"].fields:
    nnpdf31lo_hist_dict[member_name].fill(
        z2lmz1lp_dilepton_vec.m, 
        weight=tree["NNPDF31LO_Members"][member_name][Z2lmZ1lp_masks]*scale_factor
    )
    nnpdf31lo_hist_dict[member_name].fill(
        z2lpz1lm_dilepton_vec.m, 
        weight=tree["NNPDF31LO_Members"][member_name][Z1lmZ2lp_masks]*scale_factor
    )
for member_name in tree["MSHT20LO_Members"].fields:
    msht20lo_hist_dict[member_name].fill(
        z2lmz1lp_dilepton_vec.m, 
        weight=tree["MSHT20LO_Members"][member_name][Z2lmZ1lp_masks]*scale_factor
    )
    msht20lo_hist_dict[member_name].fill(
        z2lpz1lm_dilepton_vec.m, 
        weight=tree["MSHT20LO_Members"][member_name][Z1lmZ2lp_masks]*scale_factor
    )
for member_name in tree["PDF4LHC21_Members"].fields:
    pdf4lhc_hist_dict[member_name].fill(
        z2lmz1lp_dilepton_vec.m, 
        weight=tree["PDF4LHC21_Members"][member_name][Z2lmZ1lp_masks]*scale_factor
    )
    pdf4lhc_hist_dict[member_name].fill(
        z2lpz1lm_dilepton_vec.m, 
        weight=tree["PDF4LHC21_Members"][member_name][Z1lmZ2lp_masks]*scale_factor
    )
...
nnpdf31lo_rmslow_hist.view().value[0] = 0.0
nnpdf31lo_rmslow_hist.view().value[-2] = 0.0
...
msht20lo_rmslow_hist.view().value[-2] = 0.0
msht20lo_rmslow_hist.view().value[-1] = 0.0
