...
// Thu Jun 16 09:54:13 2022 by ROOT version 6.26/02
// from TTree LHEF/Analysis tree
// found on file: WW_DoubleBosonDecay.root
//////////////////////////////////////////////////////////

#ifndef WWBosonClass_h
#define WWBosonClass_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   WWBosonClass(TTree *tree=0);
   virtual ~WWBosonClass();
...
#ifdef WWBosonClass_cxx
WWBosonClass::WWBosonClass(TTree *tree) : fChain(0) 
{
...
WWBosonClass::~WWBosonClass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t WWBosonClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WWBosonClass::LoadTree(Long64_t entry)
{
...
void WWBosonClass::Init(TTree *tree)
{
...
void WWBosonClass::Show(Long64_t entry)
{
...
Int_t WWBosonClass::Cut(Long64_t entry)
{
