...
# Create Indices
first_lepton_key = 'l_plus_array'
second_lepton_key = 'l_minus_array'

# Create Vectors
lminus_vec = vector.zip({
    'px': tree[first_lepton_key][:,0],
    'py': tree[first_lepton_key][:,1],
    'pz': tree[first_lepton_key][:,2],
    'e': tree[first_lepton_key][:,3],
})

lplus_vec = vector.zip({
    'px': tree[second_lepton_key][:,0],
    'py': tree[second_lepton_key][:,1],
    'pz': tree[second_lepton_key][:,2],
    'e': tree[second_lepton_key][:,3],
})
